...
if __name__ == "__main__":
    ...
    print(dimmed("This is a dimmed message."))
    print(debug("This is a debug message."))
    print(red("This is a red message."))
    print(green("This is a green message."))
    print(cyan("This is a cyan message."))
    print(magenta("This is a magenta message."))
    print(yellow("This is a yellow message."))
    print(blue("This is a blue message."))